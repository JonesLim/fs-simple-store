...
class Orders
{
    ...
    public function createNewOrder( 
        $user_id, // to find out who makes the order
    ...
    )
    {
        ...
        {
            // insert each product in kcart as new row in the orders_products table
            $statement = $this->database->prepare (
    ...
    {
        // load the orders data from database based on the given user_id
